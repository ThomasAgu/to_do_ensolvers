...
import axios from "axios";
  ...
  const TodoList = ({todos, setTodos,  change,  setChange}) => {
  ...
  return (
    <div>
        ...
        {todos.map((todo) => (
          <Todo key={todo.id} info={todo.info} finished={todo.finised} setTodos={setTodos} todos={todos} todo={todo}  change={change}  setChange={setChange} todoEdit={todoEdit} setToDoEdit={setToDoEdit} />
        ))}
        <div>
